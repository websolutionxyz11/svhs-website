...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Sree Vidya High School Penumur | Best & Top School in Penumur, Chittoor | Admissions Open" },
      { name: "description", content: "Sree Vidya High School in Penumur is one of the best and top-rated schools in Chittoor district. We offer quality education from LKG to 10th class with experienced teachers, modern facilities, and excellent results. Admissions open now." },
      { name: "keywords", content: "Sree Vidya High School, Sree Vidya High School Penumur, best school in Penumur, top school in Penumur Chittoor, schools in Penumur, English medium school Penumur, SVHS Penumur" },
      { name: "author", content: "Sree Vidya High School" },
      { property: "og:title", content: "Sree Vidya High School Penumur | Best School in Chittoor" },
      { property: "og:description", content: "Top-rated school in Penumur offering quality education, modern facilities, and holistic development. Admissions open." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Sree Vidya High School" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Sree Vidya High School Penumur" },
        { name: "twitter:description", content: "Best school in Penumur with quality education and modern facilities. Admissions open" },
